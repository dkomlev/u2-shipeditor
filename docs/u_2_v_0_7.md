# ТЗ: обновление ТТХ кораблей, номиналов, редактора и флай‑теста (U2 v0.7.5, decoupled)
...
- **ShipConfig**: `schema` v0.7.5  
- **Nominals**: v0.7.5 (decoupled, на базе данных v0.7.4) — подготовленные файлы:  
...
## 5. ShipConfig v0.7.5 — изменения схемы
